...
This is overfit because k = 1.  It categorizes perfectly.
...
#7. (GRAD ONLY) On the plot produced in part 1, plot the predicted value of species over a grid of points using the same color scheme used in part 1.
